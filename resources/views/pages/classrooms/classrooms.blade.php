                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('Classrooms.update', 'test') }}" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <label for="Name"
                                                            class="mr-sm-2">{{ trans('classrooms_trans.stage_name_ar') }}
                                                            :</label>
                                                        <input id="Name" type="text" name="Name"
                                                            class="form-control"
                                                            value="{{$My_Class->getTranslation('classroom_name', 'ar')}}"
                                                            required>
                                                    ...
                                                    <div class="col">
                                                        <label for="Name_en"
                                                            class="mr-sm-2">{{ trans('classrooms_trans.stage_name_en') }}
                                                            :</label>
                                                        <input type="text" class="form-control"
                                                            value="{{$My_Class->getTranslation('classroom_name', 'en')}}"
