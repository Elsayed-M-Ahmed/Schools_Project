                    ...
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#roolback_all">
                                   تراجع الكل
                                </button>
                                <br><br>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>{{$promotion->f_classroom->classroom_name}}</td>
                                                <td>{{$promotion->f_section->Name_Section}}</td>
                                                <td>{{$promotion->t_grade->Name}}</td>
                                                <td>{{$promotion->academic_year_new}}</td>
                                                <td>{{$promotion->t_classroom->classroom_name}}</td>
                                   ...
                                   @include('pages.Students.promotion.roolback_all')
                                   @include('pages.Students.promotion.roolback_one')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
