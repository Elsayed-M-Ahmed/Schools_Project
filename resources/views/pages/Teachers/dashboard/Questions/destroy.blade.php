<div class="modal fade" id="delete_exam{{$question->id}}" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <form action="{{route('teacher_questions.destroy',$question->id)}}" method="post">
            {{method_field('delete')}}
            {{csrf_field()}}
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> {{ trans('classrooms_trans.Warning_Grade') }} <span class="text-danger">{{$question->title}}</span></p>
                </div>
