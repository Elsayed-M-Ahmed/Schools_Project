    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="quizzes-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{route('teacher_quizzes.index')}}">قائمة الاختبارات</a></li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('zoom_online_classes.index')}}">حصص اونلاين مع زوم</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{ route('attendence.report') }}">تقرير الحضور والغياب</a></li>
